...
file_name_observed <- file.path(output_dir, paste0(trait,  'Add_OP_Parent2_CVOO', i, ".csv"))
write.csv(data_pre_observed, file = file_name_observed, row.names = FALSE)

file_name_result <- file.path(output_dir, paste0(trait, "_Add_Result_Parent2_CVOO", i, ".csv"))
