...
file_train <- paste0("/home/uni08/osatohanmwen/2NP_final/Dataset_Parent1_CVO/xtrain_", i, ".csv")
file_test <- paste0("/home/uni08/osatohanmwen/2NP_final/Dataset_Parent1_CVO/xtest_", i, ".csv")
...
output_dir <- "/home/uni08/osatohanmwen/2NP_final/GBLUP_Result_Parent1_CVO"
...
file_name_observed <- file.path(output_dir, paste0(trait, 'Ad_dom_OP_Parent1_CVO', i, ".csv"))
write.csv(data_pre_observed, file = file_name_observed, row.names = FALSE)

file_name_result <- file.path(output_dir, paste0(trait, "_Addom_Result_Parent1_CVO", i, ".csv"))
