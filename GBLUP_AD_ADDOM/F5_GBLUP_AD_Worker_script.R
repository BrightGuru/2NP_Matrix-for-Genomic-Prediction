...
file <- paste0("/home/uni08/osatohanmwen/2NP_final/",trait ,"_BLUES_All_final",".csv")
...
file_train <- paste0("/home/uni08/osatohanmwen/2NP_final/Dataset_5F/xtrain_", i, ".csv")
file_test <- paste0("/home/uni08/osatohanmwen/2NP_final/Dataset_5F/xtest_", i, ".csv")
...
file_name <- paste0(trait, 'Add_OP_5F', i, '.csv')
#write.csv(data_pre_observed, file = file_name, row.names = FALSE)
#write.csv(data_accuracy,file = paste0(trait,"_Add_Result_5F", i,".csv"),row.names = F)


output_dir <- "/home/uni08/osatohanmwen/2NP_final/GBLUP_Result_5F"
...
file_name_observed <- file.path(output_dir, paste0(trait, 'Ad_OP_5F', i, ".csv"))
write.csv(data_pre_observed, file = file_name_observed, row.names = FALSE)

file_name_result <- file.path(output_dir, paste0(trait,"_Add_Result_5F", i, ".csv"))
