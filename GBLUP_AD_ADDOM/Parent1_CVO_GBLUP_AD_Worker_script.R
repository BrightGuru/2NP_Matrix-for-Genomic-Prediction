...
file_name_observed <- file.path(output_dir, paste0(trait, 'Ad_OP_Parent1_CVO', i, ".csv"))
write.csv(data_pre_observed, file = file_name_observed, row.names = FALSE)

file_name_result <- file.path(output_dir, paste0(trait, "_Add_Result_Parent1_CVO", i, ".csv"))
